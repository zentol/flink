...
public class OperatorGroupTest extends TestLogger {
	...
	public void testGenerateScopeDefault() throws Exception {
		...
		InternalOperatorMetricGroup opGroup = new InternalOperatorMetricGroup(registry, taskGroup, new OperatorID(), "myOpName");
	...
	public void testVariables() {
		...
		InternalOperatorMetricGroup opGroup = new InternalOperatorMetricGroup(registry, taskGroup, oid, "myOpName");
	...
	public void testCreateQueryServiceMetricInfo() {
		...
		InternalOperatorMetricGroup operator = new InternalOperatorMetricGroup(registry, task, oid, "operator");
