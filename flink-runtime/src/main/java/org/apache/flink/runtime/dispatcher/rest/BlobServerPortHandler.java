 ...
 *
 * <p>It that accepts {@link EmptyRequestBody}s and returns a {@link BlobServerPortResponseBody}.
 */
public final class BlobServerPortHandler extends AbstractRestHandler<DispatcherGateway, EmptyRequestBody, BlobServerPortResponseBody, EmptyParameters> {
	...
	public BlobServerPortHandler(CompletableFuture<String> localRestAddress, GatewayRetriever<DispatcherGateway> leaderRetriever, Time timeout) {
		super(localRestAddress, leaderRetriever, timeout, new BlobServerPortHeaders());
	}

	@Override
	protected CompletableFuture<BlobServerPortResponseBody> handleRequest(@Nonnull HandlerRequest<EmptyRequestBody, EmptyParameters> request, @Nonnull DispatcherGateway gateway) throws RestHandlerException {
		return gateway
