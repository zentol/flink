 ...
 */
public class LegacyRestHandlerAdapter<T extends RestfulGateway, R extends ResponseBody, M extends MessageParameters> extends AbstractRestHandler<T, LegacyRequest, R, M> {
	...
	public LegacyRestHandlerAdapter(
			...
			Time timeout,
			MessageHeaders<LegacyRequest, R, M> messageHeaders,
	...
	@Override
	protected CompletableFuture<R> handleRequest(@Nonnull HandlerRequest<LegacyRequest, M> request, @Nonnull T gateway) throws RestHandlerException {
