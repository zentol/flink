...
public class JobSubmission {
	...
	public static class JobSubmissionStandInBuilder {
		...
		public JobSubmissionStandInBuilder(final Path jar) {
		 ...
		 */
		public JobSubmissionStandInBuilder setParallelism(final int parallelism) {
			this.parallelism = parallelism;
			return this;
		}
		 ...
		 * @return the modified builder
		 */
		public JobSubmissionStandInBuilder setDetached(final boolean detached) {
			this.detached = detached;
			return this;
		}
		 ...
		 * @return the modified builder
		 */
		public JobSubmissionStandInBuilder addArgument(final String argument) {
		 ...
		 * @return the modified builder
		 */
		public JobSubmissionStandInBuilder addArgument(final String key, final String value) {
			addArgument(key);
			addArgument(value);
			return this;
		}
