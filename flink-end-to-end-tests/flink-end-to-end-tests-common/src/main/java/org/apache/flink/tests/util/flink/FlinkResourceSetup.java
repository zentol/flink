...
public class FlinkResourceSetup {
	...
	public static class FlinkResourceSetupBuilder {
		...
		private final Collection<String> jarsToCopyFromOptToLib = new ArrayList<>();
		...
		public FlinkResourceSetupBuilder copyJarFromOptToLib(String jarNamePrefix) {
			this.jarsToCopyFromOptToLib.add(jarNamePrefix);
			return this;
		}

		public FlinkResourceSetup build() {
			return new FlinkResourceSetup(config, jarMoveOperations);
		}
	}
