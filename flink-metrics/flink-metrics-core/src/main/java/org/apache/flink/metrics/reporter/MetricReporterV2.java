...
public interface MetricReporterV2 {
	 ...
	 * @param group the group that contains the metric
	 */
	void notifyOfRemovedMetric(StringMetric metric, String metricName, MetricGroup group);
	 ...
	 * @param group the group that contains the metric
	 */
	void notifyOfAddedMetric(NumberMetric metric, String metricName, MetricGroup group);
	 ...
	 * @param group the group that contains the metric
	 */
	void notifyOfRemovedMetric(NumberMetric metric, String metricName, MetricGroup group);
	 ...
	 * @param group the group that contains the metric
	 */
	void notifyOfAddedMetric(Histogram metric, String metricName, MetricGroup group);
	 ...
	 * @param group the group that contains the metric
	 */
	void notifyOfRemovedMetric(Histogram metric, String metricName, MetricGroup group);
}
