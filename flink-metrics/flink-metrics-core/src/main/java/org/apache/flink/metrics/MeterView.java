 ...
 * Instead, a history of rate is maintained that is updated in regular intervals by a background thread. From this
 * history a rate is retrieved on demand, which represents the average rate of events over the given time span.
 * 
 ...
 * A high value in turn increases memory-consumption since a longer history has to be maintained but will generate
 * smoother transitions between updates.
 * 
