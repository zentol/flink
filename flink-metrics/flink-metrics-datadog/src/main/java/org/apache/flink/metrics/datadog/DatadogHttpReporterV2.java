...
import org.apache.flink.metrics.NumberMetric;
import org.apache.flink.metrics.StringMetric;
 ...
 */
public class DatadogHttpReporterV2 implements MetricReporterV2, Scheduled {
	private static final Logger LOGGER = LoggerFactory.getLogger(DatadogHttpReporterV2.class);
	...
	public void open(Properties config) {
		client = new DatadogHttpClient(config.getProperty(API_KEY, null));
		LOGGER.info("Configured DatadogHttpReporter");

		configTags = getTagsFromConfig(config.getProperty(TAGS, ""));
	}
	...
	@Override
	public void notifyOfRemovedMetric(StringMetric metric, String metricName, MetricGroup group) {

	}

	@Override
	public void notifyOfAddedMetric(NumberMetric metric, String metricName, MetricGroup group) {

	}

	@Override
	public void notifyOfRemovedMetric(NumberMetric metric, String metricName, MetricGroup group) {

	}

	@Override
	public void notifyOfAddedMetric(Histogram metric, String metricName, MetricGroup group) {

	}

	@Override
	public void notifyOfRemovedMetric(Histogram metric, String metricName, MetricGroup group) {
