...
public class ElasticsearchSinkBaseTest {
	...
	public void testCollectionArgumentNotModified() {
		...
		userConfig.put(org.apache.flink.streaming.connectors.elasticsearch.ElasticsearchSinkBase.CONFIG_KEY_BULK_FLUSH_BACKOFF_DELAY, "1");
		userConfig.put(org.apache.flink.streaming.connectors.elasticsearch.ElasticsearchSinkBase.CONFIG_KEY_BULK_FLUSH_BACKOFF_ENABLE, "true");
		userConfig.put(org.apache.flink.streaming.connectors.elasticsearch.ElasticsearchSinkBase.CONFIG_KEY_BULK_FLUSH_BACKOFF_RETRIES, "1");
		userConfig.put(org.apache.flink.streaming.connectors.elasticsearch.ElasticsearchSinkBase.CONFIG_KEY_BULK_FLUSH_BACKOFF_TYPE, "CONSTANT");
		userConfig.put(org.apache.flink.streaming.connectors.elasticsearch.ElasticsearchSinkBase.CONFIG_KEY_BULK_FLUSH_INTERVAL_MS, "1");
		userConfig.put(org.apache.flink.streaming.connectors.elasticsearch.ElasticsearchSinkBase.CONFIG_KEY_BULK_FLUSH_MAX_ACTIONS, "1");
		userConfig.put(org.apache.flink.streaming.connectors.elasticsearch.ElasticsearchSinkBase.CONFIG_KEY_BULK_FLUSH_MAX_SIZE_MB, "1");
						...
						if (nextBulkFailure == null) {
							...
							for (int i = 0; i < currentBulkRequest.requests().size(); i++) {
								...
								if (mockItemFailure == null) {
									...
									mockResponses[i] = new BulkItemResponse(i, DocWriteRequest.OpType.CREATE, new BulkItemResponse.Failure("index", "type", "id", mockItemFailure));
								}
							}
	...
	private static class DummyRetryFailureHandler implements RequestFailureHandler {
