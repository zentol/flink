...
import org.apache.flink.streaming.connectors.elasticsearch.util.SourceSinkDataTestKit;
...
import static org.apache.flink.streaming.connectors.elasticsearch.ElasticsearchSinkBase.CONFIG_KEY_BULK_FLUSH_MAX_ACTIONS;
...
public abstract class ElasticsearchSinkTestBase extends AbstractTestBase {
	...
	public void runTransportClientTest() throws Exception {
		...
		userConfig.put(CONFIG_KEY_BULK_FLUSH_MAX_ACTIONS, "1");
