...
/**
 * An implementation of {@link RequestFailureHandler} is provided by the user to define how failed
 ...
 * <pre>{@code
 *
 * 	private static class ExampleRequestFailureHandler implements RequestFailureHandler {
 *
 * 		@Override
 ...
 */
@PublicEvolving
public interface RequestFailureHandler extends Serializable {
