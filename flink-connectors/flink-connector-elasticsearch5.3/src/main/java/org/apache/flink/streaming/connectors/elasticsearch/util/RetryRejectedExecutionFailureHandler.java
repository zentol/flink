...
/**
 * An {@link RequestFailureHandler} that re-adds requests that failed due to temporary
 ...
 */
@PublicEvolving
public class RetryRejectedExecutionFailureHandler implements RequestFailureHandler {
