...
public abstract class ElasticsearchSinkBase<T> extends RichSinkFunction<T> implements CheckpointedFunction {
	...
	private final RequestFailureHandler failureHandler;
	 ...
	 *
	 * <p>This is incremented whenever the user adds (or re-adds through the {@link RequestFailureHandler}) requests
	 ...
	 * {@link RequestFailureHandler#onFailure(DocWriteRequest, Throwable, int, RequestIndexer)} method.
	 *
	...
	public ElasticsearchSinkBase(
		...
		checkArgument(InstantiationUtil.isSerializable(failureHandler),
			"The implementation of the provided RequestFailureHandler is not serializable. " +
				"The object probably contains or references non-serializable fields.");
