...
public class ContextClassLoadingSettingTest extends TestLogger {
    ...
    // thread will execute the operation instead.
    // We hence take a probabilistic approach: Assume that this timing is rare, guard these calls in
    // the test with a temporary class
    // loader context, and assert that the actually used
    ...
    @Test
    public void testAkkaRpcService_ConnectSetsFlinkContextClassLoader() throws Exception {
    ...
    @Test
    public void testAkkaRpcActor_RPCFutureCompletedWithFlinkContextClassLoader() throws Exception {
        try (final TestEndpoint testEndpoint = new TestEndpoint(akkaRpcService)) {
            testEndpoint.start();
    ...
    @Test
    public void testSupervisorActor_TerminationFutureCompletedWithWithFlinkContextClassLoader()
            throws Exception {
        final TestEndpoint testEndpoint = new TestEndpoint(akkaRpcService);
        testEndpoint.start();
